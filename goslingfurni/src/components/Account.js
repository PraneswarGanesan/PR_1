...
const Account = ({ user, onUpdateUser }) => {
  ...
  useEffect(() => {
    // Update editedUsername and editedPassword when user prop changes
            ...
            {editMode ? (
              <div className='center-box'>
                ...
                <div className='security-info'>
                  ...
                  <p>Ensuring the security of your account is our top priority. Here are some tips to help you maintain a secure account:</p>
                  <ul>
                    <li>
